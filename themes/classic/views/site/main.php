        ...
        <div class="header_top">
            <div class="header_top_l">
                <ul>
                    ...
                    <li style="margin: 12px 0 0;"><a href="#"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/vk_icon.png" alt="vk" /></a></li>
                </ul>
            </div>
            <div class="header_top_r">
                <div class="header_top_r_l">
                    ...
                    <?php else: ?>
                    <a href="<?php echo Yii::app()->createUrl('user/update'); ?>"><?php echo Yii::app()->user->mname; ?></a> /
...
<div class="site_center">
    ...
    <div class="footer">
        ...
        <div class="social_icons">
            <a href="#"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/soc1.png" alt="Соц. Кнопка 1" /></a>

...
<div class="view<?php echo $css_class; ?>">
    ...
    <div style="float: left;width: 285px;">
        ...
        <b><?php echo $data->getAttributeLabel('phone'); ?>:</b> <?php echo $data->phone; ?><br>
    ...
    <div style="float: left;width: 600px;">
        <table class="order-cart">
            ...
            <tr>
                <td>Скидка</td>
                <td><?php echo $data->discount?$data->discount:'0'; ?>%</td>
            </tr>
                <tr>
                    <td><b>Итого</b></td>
                    <td><b><?php echo Yii::app()->priceFormatter->format($data->cost+$data->delivery_price, true); ?></b></td>
                </tr>
        </table>
    </div>

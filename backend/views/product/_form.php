...
<div class="row">
	<?php echo $form->labelEx($model,'covering'); ?>
	<?php echo $form->dropDownList($model,'covering', $model->getCoveringList(), array('empty'=>'Не заполнено')); ?>
	<?php echo $form->error($model,'covering'); ?>
</div>

<div class="row">
 	<?php echo $form->labelEx($model,'video'); ?>
 	<?php echo $form->dropDownList($model,'video', $model->getCoveringList(), array('empty'=>'Не заполнено')); ?>
...
<div class="row">
       <?php echo $form->checkBox($model,'accessory'); ?>
...
<div class="row" style="display: none;">
       <?php echo $form->checkBox($model,'in_promotion'); ?>
       <?php echo $form->label($model,'in_promotion'); ?>
	<?php echo $form->error($model,'in_promotion'); ?>
</div>


    <div class="row">
           <?php echo $form->checkBox($model,'novelty'); ?>

...
class Config extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
            ...
            'afterbuy_text' => 'Текст после оформления заказа',
            ...
            'user_register_text' => 'Текст отправляемый пользователю',
        );
	}

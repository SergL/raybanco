...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('role, email, status, phone, name', 'required'),
            array('phone, comment, address', 'filter', 'filter'=>'strip_tags'),
			array('payment_id, delivery_id, group_id, status', 'numerical', 'integerOnly'=>true),
            ...
            array('subscription', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
            ...
            'name'=>'Ф.И.О.',
            'subscription'=>'Подписатся на получение новостей и акций на Email',
		);
	}
